...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String shareTextContent= "Share text";
    ...
    private void shareText(String param){
        ...
        ShareCompat.IntentBuilder.from(this).setChooserTitle(title).setType(mimeType).setText(param).startChooser();

        //intentBuilder = new ShareCompat.IntentBuilder(this);
